...
public class MyScheduleCalendarRecyclerAdapter extends RecyclerView.Adapter<MyScheduleCalendarRecyclerAdapter.viewHolder> {
    Context context;
    String[] data;

    public MyScheduleCalendarRecyclerAdapter(Context context, String[] data) {
        super();
