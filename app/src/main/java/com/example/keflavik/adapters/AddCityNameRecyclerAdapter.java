...
import com.example.keflavik.pragments.AddApartmentFragment;

public class AddCityNameRecyclerAdapter extends RecyclerView.Adapter<AddCityNameRecyclerAdapter.ViewHoler>{
    Context context;
    String[] cityName;

    public int mSelectedItem = -1;

    public AddCityNameRecyclerAdapter(Context context, String[] cityName){
    ...
    public ViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_add_apartment_city_name_button,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHoler holder, @SuppressLint("RecyclerView") int position) {
        ...
        Log.e("setText" , cityName[position]) ;
